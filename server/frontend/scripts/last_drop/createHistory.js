//import { jsonObjectTools } from './init_14_1.js';
//import { jsonObjectCells } from './init_14_1.js';
//import { deleteLoad } from './deleteLoafffffsfffffffffffffg.js';

    // Функция для создания строк истории на основе JSON-данных
    export function createHistory(containerId, jsonObjectHistory) {
        ...
        for (const operationKey in jsonObjectHistory.operation) {
            ...
            confirmDeleteButton.addEventListener('click', () => {
                ...
                deleteLoad(jsonObjectHistory, jsonObjectCells, jsonObjectTools, planName, groupIndex, toolName, cellId);
            });

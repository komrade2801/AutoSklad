...
class EngineError(BaseCRUD):
    ...
    def __init__(self, session: Session=None):
        ...
        super().__init__(session=session, model=Error)

    def add_error(self, error_id, error_type, message) -> bool:
        """
    ...
    def delete_error(self, error_id: int) -> bool:
        ...
        return self.delete(index=error_id)
        # try:except Exception as e:
    ...
    def create_error(self,
        ...
        :return: Объект Error или None, если ошибка не найдена.
        """
        return self.add_error(error_id, error_type, message)
    ...
    def get_error(self, error_id):
        ...
        :return: Объект Error или None, если ошибка не найдена.
        """
        return self.get_error_by_id(error_id)
    ...
    def update_error(self,
        ...
        return self.update(index=error_id, error_type=error_type, message=message)

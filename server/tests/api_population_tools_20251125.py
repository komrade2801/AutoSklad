...
class ApiConnectivityTest:
    ...
    def run_api_population_test(self):
        ...
        mass_load_data = {
            "operation": {
                "1": {"cell": "2", "tool": "1", "plan": 0},
                "2": {"cell": "3", "tool": "1", "plan": 0},
                "3": {"cell": "36", "tool": "9", "plan": 0},
                "4": {"cell": "37", "tool": "9", "plan": 0},
                "5": {"cell": "38", "tool": "9", "plan": 0},
                "6": {"cell": "41", "tool": "10", "plan": 0},
                "7": {"cell": "42", "tool": "10", "plan": 0},
                "8": {"cell": "43", "tool": "10", "plan": 0},
                "9": {"cell": "44", "tool": "10", "plan": 0},
                "10": {"cell": "45", "tool": "10", "plan": 0},
                "11": {"cell": "72", "tool": "3", "plan": 0},
                "12": {"cell": "73", "tool": "3", "plan": 0},
                "13": {"cell": "74", "tool": "3", "plan": 0},
                "14": {"cell": "150", "tool": "7", "plan": 0},
                "15": {"cell": "177", "tool": "6", "plan": 0},
                "16": {"cell": "178", "tool": "6", "plan": 0},
                "17": {"cell": "179", "tool": "6", "plan": 0},
                "18": {"cell": "180", "tool": "6", "plan": 0},
                "19": {"cell": "181", "tool": "6", "plan": 0},
                "20": {"cell": "186", "tool": "6", "plan": 0},
            }
        }

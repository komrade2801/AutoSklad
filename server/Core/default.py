...
def execute():
    try:
        ...
        roles_and_pages = {
            'Разработчик': ['Выдача инструмента', 'История операций', 'История ошибок', 'Выгрузка №', 'История выгрузок', 'Загрузка №', 'История загрузок',
                            ...
                            'Все чертежи', 'Добавление чертежа', 'Добавление нормы', 'Нормы сотрудников', 'Добавление группы'],
            'Кладовщик': ["История операций", 'Загрузка №', 'Выгрузка №', "История выгрузок", "История загрузок", "Библиотека инструмента", 'Добавление инструмента','Добавление группы', "Генерация штрих-кода", "Массовая загрузка", 'Все чертежи', 'Добавление чертежа',"Массовая выгрузка"],
            'Администратор': ['Все пользователи', 'Добавление пользователя', 'История загрузок', 'История выгрузок', 'История операций', 'Библиотека инструмента', 'Добавление инструмента', 'Добавление группы'],
            'Инженер': ['Все чертежи', 'Добавление чертежа', 'Все пользователи', 'Библиотека инструмента', 'Добавление инструмента', 'Добавление группы' ],
            'Руководитель': ['Выдача инструмента', 'История операций', 'Выгрузка №', 'Выгрузка №', 'История выгрузок', 'Загрузка №', 'Загрузка №', 'История загрузок',
                             'Библиотека инструмента', 'Добавление инструмента', 'Генерация штрихкода', 'Настройка', 'Добавление пользователя', 'Все пользователи',
                             'Информация', 'Массовая загрузка', 'Массовая выгрузка', 'Управление запасами',
                             'Все чертежи', 'Добавление чертежа'],
            'Пользователь': ['Выдача инструмента', 'Управление запасами']
        }

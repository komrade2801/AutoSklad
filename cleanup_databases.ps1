...
.DESCRIPTION
    Deletes all database files, command queue JSON files and log files (sync.log,
    app.log, error.log) from both client and server directories, regardless of

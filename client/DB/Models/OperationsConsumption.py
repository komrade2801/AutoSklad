...
class OperationsConsumption(Base, Model):
    ...
    id = Column(Integer, primary_key=True, nullable=False, autoincrement=True,
                comment="Уникальный идентификатор записи операции")
    ...
    consumption_id = Column(Integer, ForeignKey("Consumption.id"), nullable=False,
                            comment="Идентификатор расхода из таблицы Consumption")
    history_id = Column(Integer, ForeignKey("History.id"), nullable=False,
                        comment="Идентификатор записи из таблицы History")
    consumption_tools_id = Column(Integer, ForeignKey("ToolTypes.id"), nullable=False,
                                  comment="Идентификатор инструмента из таблицы ToolTypes")
    status_id = Column(Integer, ForeignKey("Status.id"), nullable=False,
                       comment="Идентификатор статуса операции из таблицы Status")

...
class OperationsConsumption(Base, Model):
    ...
    def __repr__(self):
        ...
        return (f"<OperationsConsumption("
                f"id={self.id}, "
                f"date={self.date}, "
...
# status = relationship("Status", back_populates="operations_consumption")
# stories = relationship("History", back_populates="operations_consumption")
# consumptions = relationship("Consumption", back_populates="operations")
# tools = relationship("Tools", back_populates="operations_consumption")

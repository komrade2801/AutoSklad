...
# if 'Drop' not in Base.metadata.tables:
...
# tools = relationship("Tools", back_populates="DropOperations")
# drops = relationship("Drop", back_populates='operations')
# status = relationship("Status", back_populates="DropOperations")
# stories = relationship("History", back_populates="DropOperations")

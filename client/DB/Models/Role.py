...
# rights = relationship('Rights', back_populates='Roles')  # Связь с таблицей прав доступа (Rights)
# users = relationship('User', back_populates='Roles')  # Связь с таблицей пользователей (User)
# stories = relationship('History', back_populates='Roles')  # Связь с таблицей истории (History)

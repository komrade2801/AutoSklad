    ...
    try:
        ...
        roles_and_pages = {
            'Developer': ['Выдача инструмента', 'История операций', 'История ошибок', 'Выгрузка №', 'Выгрузка №', 'История выгрузок', 'Загрузка №', 'Загрузка №', 'История загрузок',
                          ...
                          'Все чертежи', 'Добавление чертежа', 'Добавление нормы', 'Нормы сотрудников'],
            'Stockman': ["История операций", "История ошибок", "История выгрузок", "История загрузок", "Библиотека инструмента", "Генерация штрих-кода", "Массовая загрузка", "Массовая выгрузка", "Все чертежи"],
            ...
            'Engineer': ['Все чертежи', 'Добавление чертежа', 'Добавление нормы', 'Нормы сотрудников', 'Все пользователи', 'Библиотека инструмента', 'Добавление инструмента', ],

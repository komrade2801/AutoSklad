...
# Form implementation generated from reading ui file 'screen_14_stockman.ui'
#
...
"color: rgb(0, 49, 114);")
        ...
        icon = QtGui.QIcon()  # "img/btn_ico_back.png"
        # icon.addPixmap(QtGui.QPixmap(PingGreen().get_pixmap()), QtGui.QIcon.Normal, QtGui.QIcon.Off)

        # формируем путь к файлу относительно расположения .py
        base_dir = os.path.dirname(__file__)
        icon_path = os.path.join(base_dir, '..', 'img', 'unlock.png')

        # загружаем пиксмап из файла и добавляем в QIcon
        icon.addPixmap(QtGui.QPixmap(icon_path),
                       QtGui.QIcon.Normal,
                       QtGui.QIcon.Off)  # :contentReference[oaicite:0]{index=0}


        self.btn_open_door.setIcon(icon)
        # self.btn_open_door.setIconSize(QtCore.QSize(51, 51))
        self.btn_open_door.setIconSize(QtCore.QSize(30, 30))
        self.btn_open_door.setObjectName("btn_open_door")

        self.lbl_info_ico = QtWidgets.QLabel(screen_14_stockman)
        self.lbl_info_ico.setGeometry(QtCore.QRect(95, 30, 280, 250))

...
# Form implementation generated from reading ui file 'screen_11_tool_issued.ui'
#
...
class Ui_screen_11_tool_issued(object):
    def setupUi(self, screen_11_tool_issued):
        ...
        screen_11_tool_issued.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0.5, y1:0, x2:0.5, y2:1, stop:0 rgba(47, 70, 105, 255), stop:1 rgba(131, 149, 174, 255));")
...
"color: rgb(0, 49, 114);")
        ...
        self.lbl_info_ico.setText("")  # "img/ico_ok.png"
        self.lbl_info_ico.setPixmap(QtGui.QPixmap(Ok().get_pixmap()))

...
# Form implementation generated from reading ui file 'screen_16_mass_load_ok.ui'
#
...
class Ui_screen_16_mass_load_ok(object):
    def setupUi(self, screen_16_mass_load_ok):
        ...
        screen_16_mass_load_ok.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0.5, y1:0, x2:0.5, y2:1, stop:0 rgba(47, 70, 105, 255), stop:1 rgba(131, 149, 174, 255));")

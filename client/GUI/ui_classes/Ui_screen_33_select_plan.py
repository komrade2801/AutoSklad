...
class Ui_screen_33_select_plan(object):
    def setupUi(self, screen_33_select_plan):
        ...
        screen_33_select_plan.setStyleSheet("background-color: qlineargradient(spread:pad, x1:0.5, y1:0, x2:0.5, y2:1, stop:0 rgba(47, 70, 105, 255), stop:1 rgba(131, 149, 174, 255));")

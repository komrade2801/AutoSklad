...
# Form implementation generated from reading ui file 'screen_6_user.ui'
#
...
class Ui_screen_6_user(object):
    def setupUi(self, screen_6_user):
        ...
        self.lbl_info_ico.setGeometry(QtCore.QRect(100, 60, 281, 251))
...
"background-color: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgba(0, 0, 0, 0), stop:1 rgba(255, 255, 255, 0));")
        ...
        self.lbl_info_2.setGeometry(QtCore.QRect(30, 480, 416, 36))
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 49, 114))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)

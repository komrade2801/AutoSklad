...
from GUI.widgets.ui_classes.widget_27_1_21_err_identification import Ui_widget_27_1_21_err_identification as Ui


class WidgetErrIdentification(BaseScreen, Ui):

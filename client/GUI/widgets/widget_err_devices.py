...
from GUI.widgets.ui_classes.widget_27_7_21_err_devices import Ui_widget_27_7_21_err_device


class WidgetErrDevices(BaseScreen, Ui_widget_27_7_21_err_device):

...
from GUI.widgets.ui_classes.widget_27_2_21_err_identification_barcode import Ui_widget_27_2_21_err_identification_barcode as Ui


class WidgetErrIdentificationBarcode(BaseScreen, Ui):

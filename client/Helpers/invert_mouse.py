...
# Инвертируем настройки для каждой найденной мыши
for device in device_names:
    subprocess.call(['xinput', 'set-prop', device, 'Coordinate Transformation Matrix', '-1', '0', '1', '0', '-1', '1', '0', '0', '1'])
    print(f"Настройки мыши '{device}' инвертированы.")
